...
class SearchTutorCourses extends SpotlightCommand
{
    /**
     * This is the name of the command that will be shown in the Spotlight component.
     */
    protected string $name = 'Cursos Pendiente O Progeso';

    /**
     * This is the description of your command which will be shown besides the command name.
     */
    protected string $description = 'Redirecciona a los Cursos Pendientes o en Progeso';

    /**
     * You can define any number of additional search terms (also known as synonyms)
     * to be used when searching for this command.
     */
    protected array $synonyms = ['pendientes','cursos', 'proceso'];
    ...
    {
        $spotlight->redirectRoute('tutor.profile.courses');
    }
