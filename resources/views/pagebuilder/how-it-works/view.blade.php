                                ...
                                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                    @if(!empty(pagesetting('tutor_repeater')))
                                        @foreach(pagesetting('tutor_repeater') as $option)
                                            @if($loop->odd)
                                                <div class="am-works_info am-bt-{{ $loop->index }}">
                                                    <div>
                                                        ...
                                                        <div class="am-works_info_description">
                                                            @if(!empty($option['tutor_sub_heading'])) 
                                                                ...
                                                                @endif
                                                            @endif
                                                            @if(!empty($option['tutor_heading'])) <h3 class="h3-{{ $loop->index }}">{!! $option['tutor_heading'] !!}</h3> @endif
                                                            @if(!empty($option['tutor_paragraph'])) <p class="p-{{ $loop->index }}">{!! $option['tutor_paragraph'] !!}</p> @endif                                              
                                                        </div>
                                                    </div>
                                                    <div class="am-works_info_user">
