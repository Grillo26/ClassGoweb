...
<section class="hero container">
    ...
    <!-- Texto -->
    <div class="hero-text">
        <p>Aprende y Progresa con</p>
        <h1>Tutoría en Línea</h1>
        <p>Alcanza tus metas con tutorías personalizadas de los mejores expertos.<br>
            Conéctate con tutores dedicados para asegurar tu éxito.</p>
