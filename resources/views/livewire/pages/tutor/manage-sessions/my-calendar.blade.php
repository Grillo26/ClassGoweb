                        ...
                        <form class="am-themeform am-session-form" wire:submit="addSession" autocomplete="off">
                            <fieldset  x-data="{
                                ...
                                <div @class(['form-group', 'form-group-half', 'am-invalid' => $errors->has('form.end_time') || $errors->has('form.end_time')])>
                                    <label class="am-label-calendar am-important2">{{ __('calendar.start_end_time') }}</label>
                                ...
                                @if(\Nwidart\Modules\Facades\Module::has('subscriptions') && \Nwidart\Modules\Facades\Module::isEnabled('subscriptions'))
                                    <div class="form-group form-group-half">
                                        <div class="am-switchbtn-box">
                                            <label for="" class="am-label-calendar">{{ __('subscriptions::subscription.allowed_for_subscriptions') }}</label>
                                ...
                                <div @class(['form-group', 'am-invalid' => $errors->has('form.description')])>
                                    <div class="am-label-wrap">
                                        <label class="am-label-calendar am-important2">{{ __('calendar.session_description') }}</label>
