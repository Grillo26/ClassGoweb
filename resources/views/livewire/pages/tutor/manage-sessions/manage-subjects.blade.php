                                                                        ...
                                                                        <div class="am-itemdropdown">
                                                                            ...
                                                                            <ul class="am-itemdropdown_list dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                                <li>
                                                                                    ...
                                                                                    let subjectData = {
                                                                                        edit_id: @js($subject?->pivot?->id),
                                                                                        subject_id: @js($subject?->pivot->subject_id),
                                                                                        hour_rate: @js($subject?->pivot?->hour_rate),
                                                                                        description: @js($subject->pivot->description),
                                                                                        sort_order: @js($subject?->pivot?->sort_order),
                                                                                        image: @js($subject->pivot?->image)
                                                                                    };
                                                                                    $wire.call('editSubject', {{ $group?->id }}, subjectData);
                                                                                    $nextTick(() => {
                                    ...
                                    @if(!empty(array_diff_key($subjects, $this->getUserGroupSubject($group?->id))))
                                        <div class="am-addclasses-wrapper">
                                            <button
                                                ...
                                                $wire.call('resetForm');
                                                $wire.call('addNewSubject', {{ $group?->subject_group_id }});
                                                $nextTick(() => {
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="am-modal-header">
                        ...
                        <template x-if="sessionData.edit_id == ''">
                            <h2>{{ __('subject.add_subject') }} - Grupo ID: {{ $form->group_id }}</h2>
                        </template>
