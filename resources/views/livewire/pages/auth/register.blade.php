                ...
                <div class="am-themeform__wrap">
                    <div class="form-group-wrap">
                        ...
                        <div class="form-group @error('phone_number') am-invalid @enderror">
                            <label class="am-label-register" for="phone_number" class="am-important">{{ __('general.phone_number') }}</label>
                        ...
                        <div class="form-group {{ $errors->get('password') ? 'am-invalid' : '' }}">
                            <label class="am-label-register" for="password">{{ __('auth.password_placeholder') }}</label>
                        ...
                        <div class="form-group {{ $errors->get('password') ? 'am-invalid' : '' }}">
                            <label class="am-label-register" for="password_confirmation">{{ __('auth.confirm_password_placeholder') }}</label>
                            <div class="am-passwordfield">
