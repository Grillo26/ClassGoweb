                    ...
                    <div class="am-checkout_title">
                        ...
                        <ul class="am-checkout_steptab">
                            <li class="am-checkout_steptab_checked">
                                <span><i class="am-icon-user-05"></i> <em class="am-checkicon"><i
                                            class="am-icon-check-circle03"></i></em> </span>
                                {{ __('checkout.select_best_tutor') }}
                            </li>
                            <li class="am-checkout_steptab_active">
                                <span><i class="am-icon-lock-close"></i> <em class="am-checkicon"><i
                                            class="am-icon-check-circle03"></i></em></span>
                                {{ __('checkout.add_checkout_details') }}
                            </li>
                            <li>
                                <span><i class="am-icon-flag-02"></i> <em class="am-checkicon"><i
                                            class="am-icon-check-circle03"></i></em></span>
                                            ...
                                            @if ($available_method['status'] == 'on')
                                                <div class="accordion-item">
                                                    <div class="am-radiowrap">
                                                        <div class="am-radio">
                                                            <input wire:model.lazy="form.paymentMethod" type="radio"
                                                                id="payment-qr" name="payment" value="qr">
                                                            <label for="payment-qr">
                                                                {{ __('settings.qr_payment_title') }}
                                                                <figure class="am-radiowrap_img">
                                                                    <img src="{{ asset('images/mi_qr3.jpg') }}"
                                                                        alt="{{ __('settings.qr_payment_title') }}">
                                                                </figure>
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                {{-- Mostrar QR si el usuario selecciona esta opci¨®n --}}
                                                @if ($form->paymentMethod === 'qr')
                                                <div class="am-payment-qr">
                                                    <h4 class="follow_steps">{{ __('checkout.scan_qr_code_to_pay') }}</h4>
                                                    <figure>
                                                        <img id="qrImage" src="{{ asset('images/mi_qr3.jpg') }}" alt="QR Payment">
                                                    </figure>
                                            
                                                    {{-- Bot¨®n de descarga --}}
                                                    <a id="downloadQR" href="{{ asset('images/mi_qr3.jpg') }}" download="mi_qr3.jpg" class="am-btn am-btn-primary2">
                                                        <i class="am-icon-download"></i>
                                                        {{ __('checkout.download_qr') }}
                                                    </a>
                                            
                                                    <h2 class="follow_steps">{{ __('checkout.follow_steps') }}</h2>
                                                    <p>{{ __('checkout.step_one') }}</p>
                                            
                                                    {{-- Paso 2 con bot¨®n de WhatsApp --}}
                                                    <p>{{ __('checkout.step_two') }}</p>
                                                    <a href="https://wa.me/59177573997?text={{ urlencode(__('checkout.whatsapp_message')) }}" 
                                                       target="_blank" class="am-btn am-btn-success2">
                                                        <i class="am-icon-whatsapp"></i> {{ __('checkout.send_voucher_whatsapp') }}
                                                    </a>
                                            
                                                    <p>{{ __('checkout.step_three') }}</p>
                                                    <p>{{ __('checkout.step_four') }}</p>
                                                    <p>{{ __('checkout.step_five') }}</p>
                                                </div>
                                            @endif
                                    ...
                                    @if (
                                        ...
                                        @foreach ($subscriptions as $item)
                                            <div class="accordion-item am-learner-plan">
                                                <div class="am-radiowrap">
                                                    <div class="am-radio">
                                                        <input wire:model.lazy="chosenSubscription"
                                                            {{ $chosenSubscription == $item->subscription_id ? 'checked' : '' }}
                                                            type="radio" id="payment-{{ $item->subscription_id }}"
                                                            name="payment" value={{ $item->subscription_id }}>
                                                        <label for="payment-{{ $item->subscription_id }}">
                                                            {{ __('subscriptions::subscription.subscription') }}
                                                            <span class="am-radiowrap-img">{!! formatAmount($item?->price, true) !!} <em>/
                                                                    {{ __('subscriptions::subscription.' . $item->subscription?->period) }}</em></span>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="am-learner-plan_options">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            ...
                                                            <em>{{ $item->remaining_credits['sessions'] ?? 0 }}
                                                                {{ __('subscriptions::subscription.left') }}</em>
                                                        </li>
                                                        @if (\Nwidart\Modules\Facades\Module::has('courses') && \Nwidart\Modules\Facades\Module::isEnabled('courses'))
                                                            <li>
                                                                ...
                                                                <em>{{ $item->remaining_credits['courses'] ?? 0 }}
                                                                    {{ __('subscriptions::subscription.left') }}</em>
                                                            </li>
                                                        @endif
                                                    </ul>
                            ...
                            <form class="am-themeform am-checkout_form">
                                <fieldset>
                                    ...
                                    <div @class(['form-group', 'am-invalid' => $errors->has('form.company')]) class="">
                                        <input wire:model="form.company" type="hidden" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div @class([
                                            ...
                                            <span class="am-select" wire:ignore>
                                                <select class="am-select2" data-componentid="@this" data-live="true"
                                                    data-searchable="true" id="country" data-wiremodel="form.country">
                                                    <option value="">{{ __('profile.select_a_country') }}
                                                    </option>
                                                    @foreach ($countries as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ $item->id == $form->country ? 'selected' : '' }}>
                                                            {{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                            </span>
                                    ...
                                    <div @class([
                                        ...
                                        <input wire:model="form.state" type="hidden" class="form-control"
                                    ...
                                    <div @class([
                                        ...
                                        <input wire:model="form.zipcode" type="hidden" class="form-control"
                            ...
                            <form class="am-themeform am-checkout_form">
                                <fieldset>
                                    ...
                                    @if ($walletBalance)
                                        <div class="form-group">
                                            <div class="am-checkbox ">
                                                <input wire:model.live="useWalletBalance" id="remember_me"
                                    ...
                                    <div class="form-group form-groupbtns">
                                        <x-primary-button @class(['am-btn_disabled' => !$checkoutReady]) wire:click="updateInfo"
                                            wire:target="updateInfo" type=button
                                            wire:loading.class="am-btn_disable">{{ __('checkout.pay') }}
                                            {!! formatAmount($payAmount) !!}<i
                                                class="am-icon-arrow-right"></i></x-primary-button>
                                    </div>
                                </fieldset>
                            </form>
                        </div>
                                        ...
                                        <li>
                                            <figure class="am-ordersummary_list_img">
                                                @if (!empty($item['options']['image']) && Storage::disk(getStorageDisk())->exists($item['options']['image']))
                                                    <img src="{{ resizedImage($item['options']['image'], 34, 34) }}"
                                            ...
                                            <div class="am-ordersummary_list_title">
                                                <div @class([
                                                    ...
                                                    'am-w-full' =>
                                                        !\Nwidart\Modules\Facades\Module::has('kupondeal') ||
                                                        \Nwidart\Modules\Facades\Module::isDisabled('kupondeal'),
                                                ])>
                                                ...
                                                <div class="am-ordersummary_list_action">
                                                    @if (
                                                        \Nwidart\Modules\Facades\Module::has('kupondeal') &&
                                                            \Nwidart\Modules\Facades\Module::isEnabled('kupondeal') &&
                                                            !empty($item['discounted_total']))
                                                    ...
                                                    @endif
                                                    <a wire:click='removeCart({{ $item['cartable_id'] }}, @json($item['cartable_type']))'
                                                        href="javascript:void(0);">{{ __('checkout.remove') }}</a>
                                                </div>
                                            </div>
                                        </li>
                                    @endforeach
                                    ...
                                    <div class="am-checkout_coupons">
                                                    ...
                                                    @if (
                                                        ...
                                                        <li>
                                                            <div class="am-coupon_item">
                                                                <div class="am-coupon_header"
                                                                    style="background-color: {{ $item['options']['discount_color'] }};">
                                                                    <span>
                                                                    ...
                                                                    <div class="am-coupon_shape"
                                                                        style="border-color: {{ $item['options']['discount_color'] }}">
                                                                    </div>
                                                                </div>
                                                                <div class="am-coupon_body"
                                                                    style="background-color: {{ addColorOpacity($item['options']['discount_color']) }}">
                                                                    <h3 x-data="{ copied: false, textToCopy: '{{ $item['options']['discount_code'] }}' }">
                                                                        ...
                                                                        <template x-if="copied">
                                                                            <span x-show="copied"
                                                                                x-transition>{{ __('general.copied') }}</span>
                                                                        </template>
                                                                    </h3>
                                                                    @if ($item['options']['auto_apply'] != '1')
                                                                        <a href="javascript:void(0);"
                                                                            class="am-removecoupon"
                                                                            wire:click="removeCoupon('{{ $item['options']['discount_code'] }}')"><i
                                                                                class="am-icon-multiply-02"></i></a>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        </li>
                                        ...
                                        <div class="am-checkout_coupons_footer">
                                            <input type="text" wire:model="coupon" class="form-control"
                                                placeholder="{{ __('kupondeal::kupondeal.enter_coupon') }}">
                                            <a href="javascript:void(0);" wire:loading.class="am-btn_disable"
                                                wire:target="applyCoupon" wire:click="applyCoupon"
                                                class="am-btn">{{ __('kupondeal::kupondeal.apply') }}</a>
                                        </div>
                                        @error('coupon')
